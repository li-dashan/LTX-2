...
OUTPUT_FILE="$(basename "${LTX2_OUTPUT_FILE:-two-stage.mp4}")"
...
PROMPT="${1:-A cinematic close-up of rain sliding down a window at night, neon signs outside blur into colorful reflections, the camera slowly pushes forward, shallow depth of field, realistic lighting.}"
EXTRA_ARGS=("${@:2}")
